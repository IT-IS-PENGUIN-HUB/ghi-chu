    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Đọc một lần là dùng được hết. Quên thì bấm nút <b>? Giải thích</b> ở
          góc trên màn Hôm nay và Dự án — chú thích hiện ngay tại chỗ.
        </p>
      </header>
      ...
      <Section icon={CheckSquare} title="Thêm việc" accent="wrk">
        ...
        <Tip>
          Gõ liên tiếp nhiều việc được: sau mỗi lần Enter, con trỏ vẫn nằm trong
          ô.
        </Tip>
      </Section>
      ...
      <Section icon={CheckSquare} title="Đánh dấu xong, sửa, xoá" accent="done">
        <ul className="space-y-2">
          <Bullet>
            <b>Xong:</b> tick vào ô vuông bên trái. Việc chuyển xuống mục “Đã
            xong hôm nay”.
          </Bullet>
          <Bullet>
          ...
          <Bullet>
            ...
            6 giây — việc quay lại nguyên vẹn, đúng mã cũ.
          </Bullet>
          <Bullet>
            Bỏ tick thì việc quay lại danh sách, dấu thời gian hoàn thành bị
            xoá.
          </Bullet>
        </ul>
      </Section>
            ...
            <tbody className="align-top">
              <tr className="border-b border-border/60">
                ...
                <td className="py-2.5 text-muted-foreground">
                  Số thứ tự trong danh sách <b>hôm nay</b> — <code>WORK</code>{" "}
                  là Công việc, <code>HOME</code> là Cá nhân. Sang ngày mới thì
                  đánh lại từ 01. Không dùng để tra cứu lâu dài.
                </td>
              </tr>
              <tr>
 ...
 └ Học tập
    └ Tiếng Anh cho con
       └ TA-0003`}
        ...
        <ul className="space-y-2">
          <Bullet>
            ...
            <code className="rounded bg-muted px-1 font-mono">DU_AN01</code>.
            Dài 2–8 ký tự, bắt đầu bằng chữ. Gõ tiếng Việt có dấu cũng được, app
            tự bỏ dấu.
          </Bullet>
          <Bullet>
            Không dùng được dấu <b>chấm</b> và dấu <b>gạch ngang</b>, vì mã vừa
            là tên file (
            <code className="rounded bg-muted px-1 font-mono">
              data/tasks/SNK.md
            </code>
            ) vừa là phần đầu của mã việc (
            <code className="rounded bg-muted px-1 font-mono">SNK-0042</code>) —
            dấu chấm sẽ lẫn với đuôi{" "}
            <code className="rounded bg-muted px-1 font-mono">.md</code>, còn
      ...
      <Section icon={Search} title="Tìm lại việc cũ" accent="done">
        <ul className="space-y-2">
          <Bullet>
            <b>Không cần gõ dấu:</b> gõ{" "}
            <code className="rounded bg-muted px-1">khoi luong</code> vẫn ra
            “khối lượng”.
          </Bullet>
          <Bullet>
            <b>Không cần nhớ ngày:</b> tìm trong toàn bộ lịch sử, gồm cả việc,
            ghi chú ngày và danh bạ.
          </Bullet>
          <Bullet>Gõ gần đúng vẫn ra, gõ nửa từ cũng ra.</Bullet>
        </ul>
      </Section>
      ...
      <Section icon={CalendarDays} title="Xem lại ngày cũ" accent="wrk">
        <p>
          ...
          có lịch tháng: ô càng đậm là ngày đó xong càng nhiều việc, chấm nhỏ
          dưới ô nghĩa là ngày đó có ghi chú. Bấm vào ngày để xem lại.
        </p>
      </Section>
      ...
      <Section icon={Cloud} title="Đồng bộ iPhone ↔ máy tính" accent="done">
        ...
        <p className="mt-2">
          Biểu tượng góc trên cho biết trạng thái: <b>đám mây gạch chéo</b> =
          chưa kết nối, <b>dấu tick xanh</b> = đã đồng bộ xong, <b>chấm vàng</b>{" "}
          = còn thay đổi chờ đẩy lên.
        </p>
      </Section>
      ...
      <Section icon={Smartphone} title="Cài thành app" accent="per">
        <ul className="space-y-2">
          <Bullet>
            <b>iPhone:</b> mở bằng Safari → nút Chia sẻ →{" "}
          ...
          <Bullet>
            <b>Windows (bản nổi trên màn hình):</b> cài file{" "}
            <b>GhiChu-setup.exe</b> từ mục Releases trên GitHub. Bản này có
            thêm: nút <b>ghim 📌</b> trên thanh công cụ để cửa sổ luôn nổi trên
            mọi ứng dụng khác, phím tắt toàn cục <Kbd>Ctrl</Kbd>+<Kbd>Alt</Kbd>+
            <Kbd>G</Kbd> gọi app từ bất cứ đâu (bị app khác chiếm thì tự đổi
            phím — di chuột lên icon khay để xem), và icon ở khay hệ thống — bấm
            ✕ chỉ ẩn xuống khay chứ không thoát.
          </Bullet>
        </ul>
        <Tip variant="warn">
          Trên iPhone <b>nên cài</b> chứ đừng chỉ mở bằng Safari: web thường bị
          iOS xoá dữ liệu sau 7 ngày không dùng, còn app đã cài thì không.
        </Tip>
      </Section>
